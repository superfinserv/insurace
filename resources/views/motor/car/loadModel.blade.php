	    ...
	    $rs =0; 
	     foreach ($models10 as $value) { 
    	     //if($rs==0){ //echo'<div class="col-md-1"></div>'; }?>
             	<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 model choose-model" data-animation="fadeInDown" data-delay="100" data-name="{{ucwords(strtolower($value->modal))}}" data-id="{{$value->id}}">
             ...
             <?php  $rs++;
             //if($rs==5){ echo'<div class="col-md-1"></div>';  $rs=0; }
         }
   ?>
