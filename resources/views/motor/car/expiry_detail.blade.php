 @extends($layout)
    @section('content')
      <style>
          #registrationdetailsForm .select2-container{
            z-index: 99;
         }
       ...
       <main role="main">
        <section class="invest-long page-heading-h2">
			<div class="container invest-long-bg">
						...
						<div class="row mt-3">
						   ...
						   <div class="col-md-4 col-sm-4">
						       <div class="vehicleInfoDetails-element text-center">
        						     <h2> Your <span style="color:#C52118;font-weight:600" >Car</span></h2>
        							<p></p>
        							<img src="{{asset('site_assets/img/icon/caricon.png')}}" width="200px" style="text-center">
        							<br/>
						    	</div>
							    <div id="ext-v-info" class=" text-center">
        							...
        							<p id="othr-info" style="margin-top: 0px;margin-top: 0px;font-size: 12px;font-weight: 500;font-family: Nunito,sans-serif !important;">
        							 ...
        							 <p >
        							     <a href="#" id="link-change-v-info" style="text-align: center;color: #C52118 !important;font-size: 13px;font-family: Nunito,sans-serif !important;">Not your Car?</a>
        							 </p>   
							    </div>
						   ...
						   <div class="col-md-5 col-sm-5 elm-right">
							...
							<div class="row ">
								...
								<div class="col-md-12 col-sm-12 pre-insurance-data" style="margin-top:25px;width: 100%;text-align: left;" >
									 <div  style="">
                                            <label>Select NCB on previous policy</label>
                            ...
                            <div class="row text-center term-iso-mt health-pro-a">
        			              ...
        			              <div class="col-md-6 col-sm-6">
        			                <a href="{{url('car-insurance/registration-year/')}}" style="width: 50% !important;" class="smoke-annual">Back</a>
        			              </div>
        
        			              <div class="col-md-6 col-sm-6">
        			                <button  class="smoke-annual2"  style="width: 50% !important;" >Next</button>
        			              </div>
			   ...
			   <!--             <a href="{{url('car-insurance/registration-year/')}}" class="smoke-annual">Back</a>-->
