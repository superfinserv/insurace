...
<main role="main">
				...
				<section class="invest-long page-heading-h2">
					<div class="container invest-long-bg ">
						<h2 class="text-center">Where is your <span style="color:#C52118;font-weight:600">Car</span> registered?</h2>
						<!-- <p>Select Years</p> -->
						...
						<div class="col-md-6 col-sm-6">
						    	<select class="car-registen-year br-all invest-month single-select2" id="rto_code" name="rto_code">
						...
						<div class="row text-center term-iso-mt health-pro-a">
			              <div class="col-md-6 col-sm-6">
			                <a href="{{url('car-insurance/registration-number')}}" class="smoke-annual">Back</a>
			              </div>
			              <div class="col-md-6 col-sm-6">
