						   ...
						   <div class="row text-center">
							...
							<div class="col-md-10 col-sm-10">
								 ...
								 <div class="kpx_login text-center" style="margin-top: 25px;">
								     <p class="text-center" style="margin-bottom: 0px;">Top Brands</p>
                                    <div class="row brand-section">
                                         
								 	
								 		<?php foreach ($brands10 as $value) { 
						 		$img = ($value->image!='')?asset('assets/vehicles/car/'.$value->image):asset('site_assets/logo/small-icon-logo.png');?>
