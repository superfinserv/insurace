            ...
            <table class="table table-idv">
                    <tbody>
                        <tr>
                            ...
                            <th style="width:60%"><input type="range" min="<?=$idv->minval;?>" max="<?=$idv->maxval;?>" value="<?=$idv->minval;?>" class="slider-color" id="idvRange"></th>
...
<script>
    ...
    if(twInfo.vehicle.idv.value!=null || twInfo.vehicle.idv.value!==undefined){
        if(twInfo.vehicle.idv.isLowest=="YES"){
       ...
       twInfo.idv = {isLowest:"YES",value:$('#idvRange').attr('min')} ;
       localStorage.setItem("bikeInfo", JSON.stringify(twInfo));
...
<?php if($typ=="CAR"){?>
 <script>
    ...
    if(carInfo.vehicle.idv!=null){
       ...
       carInfo.vehicle.idv = {isLowest:"YES",value:$('#idvRange').attr('min')} ;
