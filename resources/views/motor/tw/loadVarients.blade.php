...
<div class="row mt-3 text-center">
	    ...
	    foreach ($varients as $value) { 
    	     //if($rs==0){ echo'<div class="col-md-1"></div>'; }?>
              <div class="col-md-4 col-sm-4 variant choose-varient" data-animation="fadeInDown" data-fule="{{$value->fuel_type}}" data-delay="100" data-name="{{$value->variant}}" data-id="{{$value->id}}">
