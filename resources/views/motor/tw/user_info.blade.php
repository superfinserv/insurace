                ...
                <div class="col-md-7" style="background: #fff;padding-top: 25px;">
                    ...
                    <ul class="progress-indicator">
                        <li class="active" id="progress-step-1">
                            ...
                            Step 1. <br><small>(2W Owner Details)</small>
                        </li>
                                             ...
                                             <div class="col-md-6"> 
                                                 <div class="form-group">
                                                     ...
                                                     <div class="custom-control custom-radio ">
                									  	<input type="radio" class="custom-control-input" id="genderMale" name="gender" value="Male" <?=(isset($params->customer->gender) && $params->customer->gender=='Male')?'checked':'';?>>
                									  	<label class="custom-control-label" for="genderMale">Male</label>
                									</div>
                
                									<div class="custom-control custom-radio ">
                									  	<input type="radio" class="custom-control-input " id="genderFeMale" name="gender" value="Female" <?=(isset($params->customer->gender) && $params->customer->gender=='Female')?'checked':'';?>>
                                ...
                                <div class="steps" id="vehicle_data">
                                    <form class="form-group"  enctype="multipart/form-data"  id="vehicle_form" method="post" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <!--<div class="form-group">-->
                                                <!-- <label for="classic_number" style="width: 100%">upload Previous Policy</label>    -->
                                                    
                                                <!--  <div class="file-upload" >-->
                                                <!--  <div class="file-select">-->
                                                <!--    <div class="file-select-button" id="fileName">Choose File</div>-->
                                                <!--    <div class="file-select-name" id="noFile">No file chosen...</div> -->
                                                <!--    <input type="file" name="choosePolicyFile" id="choosePolicyFile">-->
                                                <!--  </div>-->
                                                <!--</div>-->
                                                <!--</div>-->
                                            </div>
