...
<div id="pageTxt">
 <p>> <span>YOUR IP :<?=$_SERVER['REMOTE_ADDR'];?> ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span></p>
...
<p>> <span>HAVE A NICE DAY  :-)</span></p>
    ...
    <script>
    var str = document.getElementById('pageTxt').innerHTML.toString();
var i = 0;
document.getElementById('pageTxt').innerHTML = "";

setTimeout(function() {
    var se = setInterval(function() {
        i++;
        document.getElementById('pageTxt').innerHTML = str.slice(0, i) + "|";
        if (i == str.length) {
            clearInterval(se);
            document.getElementById('pageTxt').innerHTML = str;
        }
    }, 10);
},0);
