                                ...
                                <tbody>
                                  ...
                                  <tfoot>
                                     ...
                                     <tr>
                                         ...
                                         <input type="hidden" id="input-payment-link" value="{{$url}}"/>
                                         <p style="margin: 5px;font-size: 12px;font-weight: 600;float: right;text-decoration: underline;"><a href="#" id="copyClipboard" data-enc="#">Copy Payment Link</a></p>
                                         </td>
                                     </tr>
                                 </tfoot>
