    ...
    <div class="card-body bd bd-t-0 rounded-bottom">
            ...
            <form class="form-group" method="post" enctype="multipart/form-data" action="#" id="MotorInsuredForm" >
               <input name="_token" type="hidden" value="{{ csrf_token() }}" />
                <input name="param" type="hidden" value="motor" />
                           <div class="row">
                     ...
                     <?php /*
                                              ...
                                              <table class="">
                                                  <tbody>
                                                         <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <select name="ncbDiscountPercent" id="ncbDiscountPercent" >
                      ...
                      <div class="row row mg-t-20">
                            <div class="col-lg-2 col-md-2">
                                    <div class="form-group">
                                      <label class="form-control-label">Net OD (without Addon)<span class="tx-danger">*</span></label>
                                      <input class="form-control" type="text" id="netOD" name="netOD" value="" placeholder="">
                                    </div>
                           </div>
                           <div class="col-lg-2 col-md-2">
                                <div class="form-group">
                                  <label class="form-control-label">Net TP(Basic)<span class="tx-danger">*</span></label>
