...
<body style="background-color: #e9ecef;">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="    max-width: 600px;border-top: 35px solid #AC0F0B;border-right: 1px solid;border-left: 1px solid;border-top-left-radius: 25px;border-top-right-radius: 25px;">
            ...
            <td align="right" valign="top" style="padding:10px 10px;background: #fff;">
              <a href="{{url('/')}}" target="_blank" style="display: inline-block;">
                <img src="https://insurance.supersolutions.in/img/site_logo/logo_5.png" alt="SuperSolutions" border="0" width="180" style="display: block;width:50%;max-width:100%;">
              </a>
            </td>
          </tr>
        </table>
    ...
    <!-- start body -->
     <tr>
      <td align="center">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;border-right: 1px solid;border-left: 1px solid;background:#fff;">
          <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="#" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset password link</a>
                        </td>
                      </tr>
                    </table>
                  </td>
