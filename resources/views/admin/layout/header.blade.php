        ...
        <nav class="nav">
            ...
            <div class="dropdown-menu dropdown-menu-header">
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img3.jpg')}}" alt="">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img4.jpg')}}" alt="">
                    <div class="media-body">
                      <div>
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img7.jpg')}}" alt="">
                    <div class="media-body">
                      <div>
                        <p>Robert Walker</p>
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img5.jpg')}}" alt="">
                    <div class="media-body">
                      <div>
                        <p>Larry Smith</p>
                        <span>Yesterday</span>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header">
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img8.jpg')}}" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img9.jpg')}}" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="{{asset('admin/images/theme-demo/img10.jpg')}}" alt="">
                    <div class="media-body">
          ...
          <div class="dropdown">
            <a href="#" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('/site_assets/logo/small-icon-logo.png')}}" class="wd-32 rounded-circle" style="border: 1px solid #ccc;">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href="#"><img src="{{asset('/site_assets/logo/small-icon-logo.png')}}" style="border: 1px solid #ccc;" class="wd-80 rounded-circle" alt=""></a>
              ...
              <ul class="list-unstyled user-profile-nav">
                ...
                @if(Auth::guard('admin')->user()->is_default)
                 <li><a href="{{url('/settings')}}"><i class="icon ion-ios-gear"></i> Settings</a></li>
                @endif
