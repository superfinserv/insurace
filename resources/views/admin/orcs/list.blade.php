  ...
  <div class="card bd-0 ">
    ...
    <!--</div><!-- card-header -->
     <div class="card-header bg-danger d-flex  align-items-center justify-content-between pd-y-5">
          <h6 class="mg-b-0 tx-14 tx-white"> ORC List</h6>
    ...
    <div class="card-body bd bd-t-0 rounded-bottom">
         <div class="table-wrapper">
            ...
            <table id="policy-orc-datatable" class="table table-bordered display">
              <thead>
                <tr>
                  <th class="text-center th-v-middle">DATE</th>
                  <!--<th class="text-center th-v-middle">MONTH</th>-->
                  <!--<th class="text-center th-v-middle">YEAR</th>-->
                  <th class="text-center th-v-middle">POLICY NO</th>
                  <th class="th-v-middle">CUSTOMER</th>
                  <th class="th-v-middle">INSURANCE</th>
                  <th class="text-center th-v-middle">AMOUNT</th>
                  <th class="text-center th-v-middle">TOTAL</th>
                  <th class="text-center th-v-middle">POSP</th>
                  <th class="text-center th-v-middle">SP</th>
                   <th class="text-center th-v-middle">POSP NAME</th>
                  <th class="text-center th-v-middle">SP NAME</th>
                </tr>
