				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<a href="#"><img src="{{get_site_settings('site_logo')}}" style="width: 300px; margin: 0 auto; margin-bottom:100px" alt="Super Finserv"></a>
						</div>
						<!--<form class=" card-sm form-group" style="margin: 0;" enctype="multipart/form-data" id="loginDetails" method="post">-->
                         {{ Form::open(array('url' => '#' ,'style'=>"margin: 0;",'class'=>"card-sm form-group",'enctype'=>"multipart/form-data", 'id'=>"loginDetails",'method'=>"post" )) }}
      							<div class="ajax_responsea"></div>
						       <div class="input-wrp">
									<input class="textfield textfield--grey" placeholder="Mobile number" name="mobile" type="text" id="mobile" maxlength="10" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
								</div>
						       <div class="input-wrp">
									<input class="textfield textfield--grey" placeholder="password" name="password" type="password" id="password">
								</div>
