					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="sighup-logo">
						  	  <a href="#"><img src="{{get_site_settings('site_logo')}}" style="width: 300px; margin: 0 auto; margin-bottom:100px"></a>
					 	   </div>     
                                    {{ Form::open(array('url' => '#' ,'style'=>"margin: 0;",'class'=>"card-sm form-group",'enctype'=>"multipart/form-data", 'id'=>"resetpasswordForm",'method'=>"post" )) }}
                                      <div class="ajax_responsea"></div>
                                        <input class="textfield textfield--grey"  name="id" type="hidden" id="id" value="{{$token}}">
                                        <div class="input-wrp">
                                          <input class="textfield textfield--grey" placeholder="New Password" name="password" type="password" id="password">
                                        </div>
                                      <div class="input-wrp">
                                          <input class="textfield textfield--grey" placeholder="Confirm password" name="confirm_password" type="password" id="confirm_password">
                                      </div>
                                     <button class="custom-btn custom-btn--medium custom-btn--style-1 wide" type="submit" role="button" style=" margin-left:0px;">Change</button> 
                                   {{ Form::close() }}
            					   </br> </br>
                                   <a href="{{url('/sign-in')}}" id="forgot_pswd" style=" float: right; ">Go to login page?</a> 
