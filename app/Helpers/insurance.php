<?php 
    ...
    // Get age from date
      ...
      if (!function_exists('SumIncRange')) { 
         function SumIncRange($key,$provider,$plan,$uType){
             if($provider=="DIGIT"){ //DIGIT
                 if($uType=="posp"){
                     $SI['2'] = ['2'=>200000,'3'=>300000];
                     $SI['4'] = ['4'=>400000,'5'=>500000];
                     return $SI[$key];
                 }else{
                     $SI['2'] = ['2'=>200000,'3'=>300000];
                     $SI['4'] = ['4'=>400000,'5'=>500000];
                     $SI['6'] = ['6'=>600000,'7'=>700000];
                     $SI['9'] = ['9'=>900000,'10'=>1000000];
                     $SI['11'] = ['15'=>1500000];
                     $SI['16'] = ['20'=>2000000];
                     $SI['21'] = ['25'=>2500000];
                     $SI['26'] = ['30'=>3000000,'40'=>4000000,'50'=>5000000];
                     return $SI[$key];
                  }
             }else if($provider=="MANIPAL_CIGNA"){ //MANIPAL_CIGNA
                 if($uType=="posp"){
             ...
             }else  if($provider=="HDFCERGO"){ //HDFCERGO
                 if($uType=="posp"){
     ...
     function sumInsuredArr($provider,$plan,$uType){
         if($provider=='DIGIT'){
             ...
             if($uType=="customer" || $uType=="sp"){
                 return ['5'=>50000,'10'=>1000000,'15'=>1500000,'20'=>2000000,'25'=>2500000,'50'=>5000000,'100'=>10000000,'200'=>20000000];
             }else{
                return ['5'=>50000]; 
             }
         }
