...
class ManipalPrime{
     ...
     function calculatePremium($params,$sum,$sumInsured,$devicetoken,$policytyp){ 
                ...
                foreach($params['members'] as $key=>$data){ 
                     if($data['type']=="self")     { $relationCd = "SELF";   $roleCd="PRIMARY"; $gender=$params['gender']; }
                        ...
                        $quotationProductInsuredDOList[]=[
                                ...
                                "cityCd"=> $_city[1],
                                "mobileNum"=> isset(Auth::guard('agents')->user()->id)?Auth::guard('agents')->user()->mobile:$params['selfMobile'],
                                "emailAddress"=> $params['selfEmail'],
                                "dob"=> $dob,
                                "zoneCd"=> $zoneCd,
                                "smokerStatusCd"=> "",
                                "chewTobaccoCd"=> "",
               ...
               $listofquotationTO[]= ["quoteId" => "","channelId"=>config('mediclaim.MANIPAL.channelId'),
                                      ...
                                      "saveFl"=> "YES","quoteTypeCd"=> "INITIAL","quotationDt"=> date('d/m/Y'),"agentId"=> $baseAgentID,
     ...
     function recalculatePremium($enqId,$termYear,$sum,$_zone,$addOn){ 
        ...
        foreach($params->members as $key=>$data){ 
             if($data->type=="self")     { $relationCd = "SELF";   $roleCd="PRIMARY"; $gender=$params->gender; }
                ...
                $quotationProductInsuredDOList[]=[
                        ...
                        "extraPremium"=> 0,
                        "discount"=> 0,
                        "productPlanOptionCd"=>$productPlanOptionCd,// $pT.'-PRT'.$sum.'-HMB500',
                        "height"=> 155,
                        "weight"=> 55,
        ...
        $adName = ['OPCBB06'=>'ProHealth-Cumulative Bonus Booster','OPHDCB03'=>'Hospital Daily Cash Benefit','OPWMC04'=>'ProHealth-Waiver Mandatory CoPay'];
     ...
     function validateProposal($enqID){
           ...
           // print_r($ProductDOList['policyProductAddOnsDOList']);
            ...
            //$req['proposalNum']="";
            $req['baseAgentId'] =$baseAgentID;//'1600099-01';
            $req['parentAgencyId'] ='';
            ...
            $req['agencyId'] ='';
            $req['subagencyId'] =(isset(Auth::guard('agents')->user()->id))?config('mediclaim.MANIPAL.subagencyId'):"";
            $req['employeeCd'] ='';
            ...
            $req['splitPolicy'] ='';
             ...
             $req['policyAgentDOList'] =[['agentId'=>$baseAgentID,'primaryAgentFl'=>'','yearFrom'=>null,'yearTo'=>null,'commPercent'=>null,'prodnPercent'=>null,]];
    ...
    function policyProductDOList_obj(){
        ...
        $elem['productPlanOptionCd'] ='IN-PRT5.5-HMB500';
